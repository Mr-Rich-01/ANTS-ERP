      ...
      <DialogContent style={{ maxWidth: 540 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 13 }}>
          ...
          <div style={{ display: 'flex', gap: 9, alignItems: 'flex-start', border: '1px solid var(--warn)', background: 'var(--warn-bg)', color: 'var(--text)', borderRadius: 8, padding: '10px 12px', fontSize: 12.5, lineHeight: 1.45 }}>
            ...
            <span>Esta operação anulará o recebimento, restaurará o saldo da factura e do cliente, criará um movimento inverso de Tesouraria e um lançamento contabilístico inverso. O recibo original permanecerá no histórico.</span>
          </div>
