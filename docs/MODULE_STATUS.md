...
| Multiempresa / RBAC | RequestContext (companyId/permissões), menu por permissões, guard de domínio | Parcial | 35 | requirePermission testado | CRUD de empresas/filiais/utilizadores/perfis, isolamento Prisma, auditoria nas operações | Autenticação | 2026-06-26 |
