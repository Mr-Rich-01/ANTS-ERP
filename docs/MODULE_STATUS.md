...
| Multiempresa / RBAC | RequestContext, menu por permissões, guard de domínio; Admin com dados reais; isolamento Prisma automático (forCompany) + auditoria automática (forContext) | Parcial | 55 | scopeArgs 8 testes + isolamento e2e na BD (A não vê B) ✓ | CRUD (criar/editar utilizadores e perfis), sessões persistidas | Autenticação | 2026-06-26 |
